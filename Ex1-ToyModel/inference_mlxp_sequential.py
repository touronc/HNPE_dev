...
from viz import display_posterior_mlxp
...
def main(ctx: mlxp.Context):
    ...
    ground_truth={}
    ground_truth["observation"] = torch.tensor([[0.2534, 0.1965, 0.3042, 0.1265, 0.4008, 0.4747, 0.0530, 0.4809,
          0.3035, 0.4276, 0.2806]])
    index = cfg.nextra +1
    true_nextra = ground_truth["observation"][:,:index]
